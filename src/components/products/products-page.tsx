...
// ★ v11.9.1: اصلاح محاسبه ارزش کل موجودی (موجودی × قیمت خرید)
// در حسابداری، ارزش موجودی بر اساس قیمت خرید (cost) محاسبه می‌شود
...
const handleSavePrice = async (productId: string, newPrice: number) => {
 ...
 // ★ v11.9.1: محاسبه مجموع ارزش کل موجودی انبار (بر اساس قیمت خرید)
// در حسابداری، ارزش موجودی بر اساس قیمت خرید (cost) محاسبه می‌شود
