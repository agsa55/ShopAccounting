...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      {/* Beautiful gradient accent bar at top */}
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute left-4 top-5 rounded-full',
          ...
          // RTL: in RTL the close button should be on the left
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-right mb-4 pr-2',
      className
    )}
    {...props}
  />
