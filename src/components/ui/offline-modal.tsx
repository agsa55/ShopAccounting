...
// ★★★ v9.8: رندر مودال در document.body برای اصلاح موقعیت‌دهی
//   (بدون این، position:fixed داخل چیدمان transform‌دار sidebar اشتباه عمل می‌کند)
...
export function OfflineModal() {
  ...
  return (
    <>
      {/* Trigger Button — در هدر باقی می‌ماند (همین آیکون یگانه است) */}
      <button
      ...
      {/* ★★★ v9.8: مودال با Portal در document.body رندر می‌شود ★★★
          این کار مشکل «مودال خیلی بالا / غیرقابل روئیت» را حل می‌کند،
          چون position:fixed حالا نسبت به viewport عمل می‌کند نه والد transform‌دار */}
