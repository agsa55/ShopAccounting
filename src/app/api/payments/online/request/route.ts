...
// ============================================================================
// ============================================================================
// ⚠️⚠️⚠️ DEPRECATED — v9.0 ⚠️⚠️⚠️
// ----------------------------------------------------------------------------
// ★ این endpoint مربوط به «تسهیم فردایی» است که کنسل شده است.
// ★ دیگر استفاده نمی‌شود. دکمه‌های پرداخت اکنون /api/payments/online/create
//   را صدا می‌زنند (درگاه اختصاصی فروشگاه).
// ★ این فایل فقط برای حفظ تاریخچه نگه داشته شده است. آن را صدا نزنید.
// ============================================================================
